...
const RestPassword: React.FC = () => {
  ...
  const handleSubmit = useCallback(async (data: RestPasswordFormData) => {
    try {
      ...
      await api.post('users/reset', { password, password_confirmation, email })
      ...
      addToast({
        ...
        description: 'Sua senha foi alterada com sucesso, voce já pode realizar o login.',
      });
    } catch (err) {
